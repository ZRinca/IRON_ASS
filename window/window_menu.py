...
class Menu:
    ...
    def run(self):
        ...
        while True:
            ...
            self.screen.blit(self.font.render(f"Играть", True, (255, 255, 255)), (745, 100))

            self.screen.blit(button_img, button_settings_rect)
            self.screen.blit(self.font.render(f"Настройки", True, (255, 255, 255)), (745, 200))

            self.screen.blit(button_img, button_quit_rect)
            self.screen.blit(self.font.render(f"Выйти", True, (255, 255, 255)), (745, 300))
